...
Usage
-----
In pom.xml, add the following xml stanza between `<repositories> ... </repositories>`

```xml
<repository>
    <id>java-faker-github-repo</id>
    <url>https://github.com/antiphish-team/java-faker/mvn-repo/</url>
    <releases>
